...
import AddNewClassModal from 'containers/pages/AddNewClassModal';
              ...
              <Colxx xxs="12">
                <Form className='d-flex align-items-center' lg="12" onSubmit={handleSubmit}>
                  <FormGroup className="form-group tooltip-right-bottom mr-4">
                    ...
                    <Input className='mb-2' type="text" name='Class' value={classData} onChange={(e) => setClassData(e.target.value)} />
                  </FormGroup>
